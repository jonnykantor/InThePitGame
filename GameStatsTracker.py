...
class GameStatsTracker (object):
	def __init__(	self, 
		...
		self.points_pos = self.t_o_a_l[7]
		...
		self.security_bar_surface.set_colorkey(LIGHT_BLUE)
		self.security_bar_surface.fill(LIGHT_BLUE)
		self.security_bar_surface.fill(RED, ((0, 0), (self.security_level, self.bar_widths)))
		self.beer_bar_surface = pygame.Surface((100, self.bar_widths)).convert()
		self.beer_bar_surface.set_alpha(200)
		self.beer_bar_surface.set_colorkey(LIGHT_BLUE)
		self.beer_bar_surface.fill(LIGHT_BLUE)		
		self.beer_bar_surface.fill(GOLD, ((0, 0), (self.beer_level, self.bar_widths)))
