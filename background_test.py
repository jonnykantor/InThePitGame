...
if __name__ == "__main__": #GLOBALS HERE
...
class CharacterObject(pygame.sprite.Sprite):
	...
	def update(self, direction):
		...
		collide_bottom = self.bottom_collision_rect.collidelist(FOREGROUND.scenery_rects)
		...
		if direction == LEFT:
			...
			if collide_bottom != -1:				
				if ( abs(self.rect.bottom - FOREGROUND.scenery_rects[collide_bottom].top) ) <= ( self.fall_speed + 2 ):
					self.isCollidingBottom = True
					self.isAirborne = False
					self.fall_speed = 0
					self.pos = (self.pos[0], FOREGROUND.scenery_rects[collide_bottom].top - self.rect.height/2 - 1)							
...
if __name__ == "__main__":
	...
	ASSETS_PATH = r'C:/Python/ServiceGame/art_assets/'
	...
	##instatiate objects
	BACKGROUND = BackgroundSurfaces(SCREEN)	
	FOREGROUND = ForegroundSurfaces(SCREEN, foreground_surfaces, FOREGROUND_ASSET_POSITIONS)
	...
	while 1:
		...
		'''
		##collision rect testing				
		pygame.draw.rect(SCREEN, LIGHT_BLUE, PLAYER.rect)
		pygame.draw.rect(SCREEN, LIGHT_BLUE, AI_CHARACTER.rect)
		
		pygame.draw.rect(SCREEN, RED, PLAYER.bottom_collision_rect)
		pygame.draw.rect(SCREEN, RED, PLAYER.right_side_collision_rect)
		pygame.draw.rect(SCREEN, RED, PLAYER.left_side_collision_rect)
		
		pygame.draw.rect(SCREEN, GREEN, AI_CHARACTER.bottom_collision_rect)
		pygame.draw.rect(SCREEN, GREEN, AI_CHARACTER.right_side_collision_rect)
		pygame.draw.rect(SCREEN, GREEN, AI_CHARACTER.left_side_collision_rect)
		##/collision rect testing
		'''
